...
y=[10 24 23 46 34 32 43 10 15 7 5]
n=length(X);
N=n-1;
lambda=0.008;
sigma=1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%% fin de spline cubique de lissage
%%%%%%%%%%%%%%%%%%%%%%%%% trace les figure
 for i=1:N
    xx=X(i):0.01:X(i+1);
...
xlabel('X ')
ylabel('Y ')
legend('spline de lissage pour lambda=0.008')
